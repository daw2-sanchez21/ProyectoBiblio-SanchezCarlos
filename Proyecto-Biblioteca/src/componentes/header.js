export const header = {
    ...
    <div class="container">
      <a class="navbar-brand" href="#"><span class="text-dark">Biblioteca</span><span class="text-primary">Llefià</span></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="libros.html">Llibres</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="salas.html">Salas</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#reservas.html">Reserves</a>
          </li>
          <li class="nav-item">
