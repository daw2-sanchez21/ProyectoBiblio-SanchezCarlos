...
export default {
  ...
  async script() {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        const titulo = form.querySelector('#titulo-id')
        const autor = form.querySelector('#autor-id')
        const isbn = form.querySelector('#isbn-id')
        const fecha = form.querySelector('#fecha-id')
